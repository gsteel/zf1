...
class Zend_OpenId_Provider
{
     ...
     *                                                 end-user (by default it is the same URL
     *                                                 with additional GET variable
     *                                                 openid.action=login)
     * @param string                       $trustUrl   is an URL that shows a question if end-user
     *                                                 trust to given consumer (by default it is
     *                                                 the same URL with additional GET variable
     *                                                 openid.action=trust)
     * @param Zend_OpenId_Provider_User    $user       is an object for communication
     *                                                 with User-Agent and store
     ...
     *                                                       or set to null, then $_GET or $_POST superglobal
     *                                                       variable is used according to REQUEST_METHOD.
     * @param  mixed                             $extensions extension object or array of extensions objects
