...
class Zend_Controller_Action_Helper_Json extends Zend_Controller_Action_Helper_Abstract
{
     ...
     *                                    NOTE:   if boolean, establish
     *                                    $keepLayouts to true|false if
     *                                    array, admit params for
     *                                    Zend_Json::encode as
     *                                    enableJsonExprFinder=>true|false
     *                                    if $keepLayouts and parmas
     *                                    for Zend_Json::encode are
     *                                    required then, the array can
     *                                    contains a
     *                                    'keepLayout'=>true|false
     *                                    and/or
     *                                    'encodeData'=>true|false that
     *                                    will not be passed to
     *                                    Zend_Json::encode method but
     *                                    will be passed to
